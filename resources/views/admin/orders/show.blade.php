<div class="box box-info">
    ...
    <div class="box-body">
      <table class="table table-bordered">
        ...
        @if($order->refund_status !== \App\Models\Order\Order::REFUND_STATUS_SUCCESS && $order->refund_status === \App\Models\Order\Order::REFUND_STATUS_PENDING &&
          ($order->type !== \App\Models\Order\Order::TYPE_CROWDFUNDING || 
