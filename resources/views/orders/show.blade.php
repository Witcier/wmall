  ...
  <div class="card-body">
    ...
    <div class="order-bottom">
      ...
      <div class="order-summary text-right">
        ...
        @endif
        @if($order->paid && $order->refund_status === \App\Models\Order\Order::REFUND_STATUS_PENDING && $order->type !== \App\Models\Order\Order::TYPE_CROWDFUNDING)
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <table class="table table-bordered table-striped text-center">
          ...
          <tbody>
          @foreach(config('installment.installment_fee_rate') as $count => $rate)
            <tr>
              <td>{{ $count }}期</td>
              <td>{{ $rate }}%</td>
              <td>
  ...
  $(document).ready(function() {
    ...
    $('#btn-apply-refund').click(function () {
      swal({
        ...
        // 请求退款接口
        axios.post('{{ route('orders.refund', [$order->id]) }}', {reason: input})
          .then(function () {
